...
trainer_image = (
    ...
    .run_commands(
        ...
        "pip install torchaudio fastapi uvicorn starlette httpx",
    )
)
        ...
        toolkit_config = {
            ...
            "config": {
                ...
                "process": [{
                    ...
                    "model": {"name_or_path": model_id, "is_flux": "flux" in model_id.lower(), "quantize": GPU not in ("H100", "H200", "B200", "A100-80GB")},
                    "sample": {
